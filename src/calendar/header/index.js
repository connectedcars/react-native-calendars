...
const BottomSheetTouchableOpacity = props => {
  const { children, ...rest } = props
  return (
    Platform.select({
      android: <RNGHTouchableOpacity {...rest} >{children}</RNGHTouchableOpacity>,
      ios: <TouchableOpacity {...rest} >{children}</TouchableOpacity>,
    })
  )
}
